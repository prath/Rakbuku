			...
			<div class="span8">
				...
				<div class="row-fluid">
					<div class="alert alert-info">
						<h4>
							Akun Anda tidak aktif, silahkan tinggalkan pesan ke admin jika ingin akun anda aktif kembali
						</h4>
					</div>
					...
					<?php
							...
							echo form_error('msg', '<div class="alert alert-warning">', '</div>');
						}
					?>
					...
					<form class="offset2" action="<?php echo base_url().'request_active';?>" method="post">
						...
						<div class="control-group">
							...
							<div class="controls">
								<textarea class="input-xlarge" name="msg" placeholder="Pesan Anda"></textarea>
							</div>
						</div>
