...
?>
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span8">
				<form class="form-horizontal" id="new_project" action="<?php echo base_url();?>admin_review/<?php echo $project_data[0]["project_url"];?>/save_edit" method="post" accept-charset="utf-8" enctype="multipart/form-data">
					<fieldset>
