...
?>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span10">
				<h1>Manage Admin</h1>
				<p class="muted">Halaman control panel untuk data - data yang berhubungan dengan Admin</p>
				...
				<ul class="breadcrumb">
					...
					<li class="active">
						<a href="<?php echo base_url()?>admin/users/manage_admin">Manage Admin</a>
					</li>
				</ul>
				<hr>
				...
				<div class="row-fluid">
					...
					<div class="pull-right">
						<input title="users" type="hidden" name="admin" value="<?php echo base_url();?>" class="destination">
						<form class="addmember" name="Tambah Admin Baru" action="<?php echo base_url()?>admin/users/add_admin">
							<a rel="tambah Admin" class="btn btn-primary modal-button add-member" rel="additem" data-toggle="modal" href="#myModal" ><i class="icon-plus icon-white"></i> Add Admin</a>
						</form>
					</div>
				</div>
				<hr>
				...
				<table class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td class="target-edit role_name"><?php echo $value['role_name'];?></td>
