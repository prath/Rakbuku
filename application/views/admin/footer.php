...
?>
    ...
    ?>
    <script src="<?php echo base_url();?>public/js/bootstrap-js-config.js"></script>
    <script src="<?php echo base_url();?>public/js/global-admin.js"></script>
    <script src="<?php echo base_url();?>public/js/page-template.js"></script>
  </body>
</html>
